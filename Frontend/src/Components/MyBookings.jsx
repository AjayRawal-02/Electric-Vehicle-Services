...
{booking.status === "waiting_customer_verification" &&
  booking.completionOTP && (
    <div className="mt-4 p-4 border-2 border-dashed border-purple-500 rounded bg-purple-50 text-center">
      <p className="text-sm text-gray-700 mb-1">
        🔐 Share this OTP with your service provider
      </p>
      <p className="text-3xl font-bold text-purple-700 tracking-widest">
        {booking.completionOTP}
      </p>
      <p className="text-xs text-gray-500 mt-2">
        OTP valid for limited time only
      </p>
    </div>
  )}
